                ...
                {SOCIALS.map((social) => (
                  <Magnetic key={social.name}>
                    <a
                      ...
                      className="w-12 h-12 rounded-full border border-white/10 bg-white/[0.02] flex items-center justify-center text-white/40 hover:text-white hover:border-accent/40 hover:bg-accent/10 transition-all duration-500"
                    >
                      <span className="text-[9px] uppercase font-black tracking-tighter">{social.icon.substring(0, 2)}</span>
                    </a>
                  </Magnetic>
                ))}
              </div>
