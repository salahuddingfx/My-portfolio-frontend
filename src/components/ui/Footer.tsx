...
const Footer = () => {
  ...
  return (
    <footer className="relative pt-24 overflow-hidden bg-[#080808]">
      ...
      {/* Background Glow */}
      <div
        className="pointer-events-none absolute -top-40 left-1/2 h-[300px] w-[600px] -translate-x-1/2 rounded-full opacity-[0.04]"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-14 border-b border-white/[0.06] pt-20 pb-14 lg:gap-16">
          ...
          <div className="flex flex-col gap-8 lg:pr-10">
            ...
            <p className="max-w-[440px] text-sm leading-relaxed text-[var(--muted)]">
              Building fast, accessible, and thoughtfully crafted digital experiences with a focus on performance, simplicity, and modern interaction.
            </p>

            <div className="flex flex-col gap-3">
              <a href="mailto:salahuddinkaderappy@gmail.com" className="group/footer inline-flex items-center gap-3 text-[13px] text-[var(--muted)] transition-colors duration-200 hover:text-white">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 lg:col-span-3">
            ...
            <div>
              ...
              <ul className="flex flex-col gap-3 items-start">
                {SOCIALS.map((social) => (
                  <li key={social.name}>
                    <a href={social.href} target="_blank" rel="noopener noreferrer" aria-label={social.name} className="footer-link text-[13px]">
